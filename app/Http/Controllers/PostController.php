...
class PostsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('posts')->with('create', 'Article successfully created!');
    }
    ...
    public function update(Request $request, Article $article)
    {
        ...
        return redirect()->route('posts')->with('edit', 'Article successfully updated!!');
    }
    ...
    public function destroy(Article $article)
    {
        ...
        return redirect()->route('posts')->with('delete', 'Artikel berhasil deleted!');
    }
