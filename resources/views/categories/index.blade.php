<x-app-layout>
    ...
    <div class="bg-white max-w-7xl mx-auto border-2 rounded-md mt-6 p-6">
        ...
        <div class="flex flex-row px-8 w-full gap-10 mb-5">
            ...
            <div class="flex-1">
                <div class="max-w-7xl mx-auto ">
                    <form class="w-full mx-auto" method="post" action="{{ route('category.store') }}">
                        @csrf
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="add-category"
                                class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Add New Category" name="name" required />
                            <button type="submit"
        ...
        @if ($categories->isEmpty())
            <h1 class="text-center text-2xl mt-4">There is no category</h1>
        @else
                    ...
                    <tbody>
                        @foreach ($categories as $index => $category)
                            <tr class="bg-white border-b">
                                ...
                                <td class="px-6 py-4 font-medium text-xl text-black category-name"
                    ...
                    <div class="max-w-7xl mx-auto">
                        <div class="flex justify-between items-center mt-4 bg-white rounded-lg p-4 border-2">
                            <div class="text-sm text-gray-600">
                                ...
                                Menampilkan kategori {{ $categories->firstItem() }} hingga {{ $categories->lastItem() }}
                                dari
    ...
    <script>
        document.querySelectorAll('.edit-button').forEach(button => {
            button.addEventListener('click', function() {
                const categoryNameCell = this.closest('tr').querySelector('.category-name');
                const currentName = categoryNameCell.textContent.trim();
                const categoryId = categoryNameCell.getAttribute('data-category-id');

                // Check if the input field already exists  
                if (categoryNameCell.querySelector('input')) {
                ...
                categoryNameCell.appendChild(input);
                input.focus();
                ...
                saveButton.addEventListener('click', function() {
                    ...
                    fetch(`/categories/${categoryId}/update`, {
